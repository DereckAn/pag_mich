...
export const CardMenu3 = ({
  ...
  return (
    <div
      id="hola"
      className="border-2 h-[350px] w-[300px] flex flex-col items-start justify-end p-4 rounded-3xl bg-[#f2f1e5] relative"
    >
      <div className="relative h-full w-full">
        <Image
          src={image}
          alt="image"
          layout="fill" // Ajusta el estilo aquí
          objectFit="cover" // Ajusta el estilo aquí
